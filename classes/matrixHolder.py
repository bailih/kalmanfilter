...
class matrixHolder_Base:
    ...
    def __init__(self, capacity, inisoc, iniV):
        ...
        case0_Q = np.matrix([[0.00000001, 0, 0],  # case 0
                             [0, 0.0001, 0],
                             [0, 0, 0.0001]])

        case1_Q = np.matrix([[0.00001, 0, 0],  # case 1
                             [0, 0.00001, 0],
                             [0, 0, 1000]])

        case2_Q = np.matrix([[0.00000001, 0, 0],  # case2
                             [0, 0.0001, 0],
                             [0, 0, 1000]])

        case3_Q = np.matrix([[0.00000001, 0, 0],  # case 3
                             [0, 0.0001, 0],
                             [0, 0, 1000]])

        case4_Q = np.matrix([[0.00000001, 0, 0],  # case 4
                             [0, 0.0001, 0],
                             [0, 0, 1000]])

        case5_Q = np.matrix([[0.00000001, 0, 0],  # case 5
                             [0, 0.0001, 0],
                             [0, 0, 0.001]])

        case6_Q = np.matrix([[0.00000001, 0, 0],  # case 5
                             [0, 0.0001, 0],
                             [0, 0, 80]])

        case0_P = np.matrix([[0.00001, 0, 0],  # case 0
                             [0, 0.0001, 0],
                             [0, 0, 100]])

        case1_P = np.matrix([[0.001, 0, 0],  # case 1
                             [0, 0.0001, 0],
                             [0, 0, 100]])

        case2_P = np.matrix([[0.000001, 0, 0],  # case 2
                             [0, 0.0001, 0],
                             [0, 0, 100]])

        case3_P = np.matrix([[0.000001, 0, 0],  # case 3
                             [0, 0.0001, 0],
                             [0, 0, 100]])

        case4_P = np.matrix([[0.000001, 0, 0],  # case 4
                             [0, 0.0001, 0],
                             [0, 0, 1000]])

        case5_P = np.matrix([[0.000001, 0, 0],  # case 5
                             [0, 0.0001, 0],
                             [0, 0, 99]])

        case6_P = np.matrix([[0.000001, 0, 0],  # case 5
                             [0, 0.0001, 0],
                             [0, 0, 999]])
        self.X = [
