...
class matrixHolder:
    ...
    3: 3.8~ Vinit 50 < SoH < 70
    4: 3.8~ Vinit 90 < SoH
    5: 3.8~ Vinit SoH < 50
    6: 3.8~ Vinit 70 < SoH < 90
    '''
    ...
    def __init__(self, capacity, inisoc, iniV):
        ...
        case1_Q = np.matrix([[0.00000001, 0, 0, 0],   #case 1
                       [0, 0.0001, 0, 0],
                       [0, 0, 100, 0],
                       [0, 0, 0, 1000]])
        ...
        case0_P = np.matrix([[0.000001, 0, 0, 0], #case 0
                           [0, 0.0001, 0, 0],
                           [0, 0, 100, 0],
                           [0, 0, 0, 100000]])

        case1_P = np.matrix([[0.000001, 0, 0, 0], #case 1
                           [0, 0.0001, 0, 0],
                           [0, 0, 100000, 0],
                           [0, 0, 0, 10000]])
